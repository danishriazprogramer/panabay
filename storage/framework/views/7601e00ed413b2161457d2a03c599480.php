...
<div class="sticky top-20 grid h-max gap-8 max-1180:hidden">
    ...
    <div class=" h-509 flex  place-content-start justify-start gap-2.5 overflow-y-auto overflow-x-hidden">
        <!-- Arrow Up -->
        <span
        ...
        <div
            ref="swiperContainer"
            class="flex max-h-[540px] gap-2.5 [&>*]:flex-[0] overflow-auto scroll-smooth scrollbar-hide"
        >
...
<?php /**PATH /var/www/html/resources/themes/default/views/products/view/gallery/desktop.blade.php ENDPATH**/ ?>