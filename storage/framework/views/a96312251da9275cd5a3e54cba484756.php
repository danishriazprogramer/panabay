...
<?php if (! $__env->hasRenderedOnce('62a2eec4-4d93-40d3-9ec9-a0e90af3301d')): $__env->markAsRenderedOnce('62a2eec4-4d93-40d3-9ec9-a0e90af3301d');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'relative bg-zinc-100 transition-all duration-300 after:block after:pb-[100%] group-hover:scale-105',':src' => 'product.base_image.medium_image_url',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '291',':alt' => 'product.name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'relative bg-zinc-100 transition-all duration-300 after:block after:pb-[100%] group-hover:scale-105',':src' => 'product.base_image.medium_image_url',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '291',':alt' => 'product.name']); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('shop.customers.account.wishlist.index')); ?>" class="absolute top-2.5 rounded-full right-0 h-auto w-[30px]"><i class="fa-regular fa-heart text-white text-2xl"></i></a>
            <?php endif; ?>
            </div>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/resources/themes/default/views/components/products/card.blade.php ENDPATH**/ ?>