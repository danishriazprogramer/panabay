                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex gap-4 max-sm:gap-2.5">
                                <?php if($address->default_address): ?>
                                    <div class="label-pending bg-navyBlue block h-fit w-max px-2.5 py-1 max-md:px-1.5">
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/themes/default/views/customers/account/addresses/index.blade.php ENDPATH**/ ?>