...
<?php if (! $__env->hasRenderedOnce('340f20df-d8d2-409f-8794-3ae4a589be1d')): $__env->markAsRenderedOnce('340f20df-d8d2-409f-8794-3ae4a589be1d');
$__env->startPush('scripts'); ?>
    ...
    >
        ...
        >
            ...
            <div
                ref="swiperContainer"
                class="flex gap-10 pb-2.5 [&>*]:flex-[0] mt-10 overflow-auto scroll-smooth scrollbar-hide max-md:gap-7 max-md:mt-5 max-sm:gap-4 max-md:pb-0 max-md:whitespace-nowrap"
            >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.products.card','data' => ['class' => 'min-w-[180px] max-md:h-fit max-md:min-w-56 max-sm:min-w-[180px]','vFor' => 'product in products']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'min-w-[180px] max-md:h-fit max-md:min-w-56 max-sm:min-w-[180px]','v-for' => 'product in products']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/html/resources/themes/default/views/components/products/carousel-new.blade.php ENDPATH**/ ?>