...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.form.control-group.control','data' => ['type' => 'email','class' => 'block mt-2 mb-2 w-[420px] max-w-full rounded-xl border-2 border-[#e9decc] bg-[#F1EADF] px-5 py-4 text-base max-1060:w-full max-md:p-3.5 max-sm:mb-0 max-sm:rounded-lg max-sm:border-2 max-sm:p-2 max-sm:text-sm','name' => 'email','rules' => 'required|email','label' => 'Email','ariaLabel' => trans('shop::app.components.layouts.footer.email'),'placeholder' => 'email@example.com']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'email','class' => 'block mt-2 mb-2 w-[420px] max-w-full rounded-xl border-2 border-[#e9decc] bg-[#F1EADF] px-5 py-4 text-base max-1060:w-full max-md:p-3.5 max-sm:mb-0 max-sm:rounded-lg max-sm:border-2 max-sm:p-2 max-sm:text-sm','name' => 'email','rules' => 'required|email','label' => 'Email','aria-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('shop::app.components.layouts.footer.email')),'placeholder' => 'email@example.com']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.accordion.index','data' => ['isActive' => false,'class' => 'hidden mt-4 mb-4 !w-full rounded-xl !border-2 !border-[#e9decc] max-1060:block max-sm:rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['is-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'hidden mt-4 mb-4 !w-full rounded-xl !border-2 !border-[#e9decc] max-1060:block max-sm:rounded-lg']); ?>
...
<?php echo view_render_event('bagisto.shop.layout.footer.after'); ?><?php /**PATH /var/www/html/resources/themes/default/views/components/layouts/footer/index.blade.php ENDPATH**/ ?>