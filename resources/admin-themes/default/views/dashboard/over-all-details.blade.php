                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-darkBlue"
                                    :class="[report.statistics.total_sales.progress < 0 ? 'icon-down-stat text-red-500 dark:!text-red-500' : 'icon-up-stat text-darkBlue dark:!text-darkBlue']"
                                ></span>

                                <p
                                    class="text-xs font-semibold text-darkBlue"
                                    :class="[report.statistics.total_sales.progress < 0 ?  'text-red-500' : 'text-darkBlue']"
                                >
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-darkBlue"
                                    :class="[report.statistics.total_orders.progress < 0 ? 'icon-down-stat text-red-500 dark:!text-red-500' : 'icon-up-stat text-darkBlue dark:!text-darkBlue']"
                                ></span>

                                <p
                                    class="text-xs font-semibold text-darkBlue"
                                    :class="[report.statistics.total_orders.progress < 0 ?  'text-red-500' : 'text-darkBlue']"
                                >
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-darkBlue"
                                    :class="[report.statistics.total_customers.progress < 0 ? 'icon-down-stat text-red-500 dark:!text-red-500' : 'icon-up-stat text-darkBlue dark:!text-darkBlue']"
                                ></span>

                                <p
                                    class="text-xs font-semibold text-darkBlue"
                                    :class="[report.statistics.total_customers.progress < 0 ?  'text-red-500' : 'text-darkBlue']"
                                >
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        ...
                        <div class="grid place-content-start gap-1">
                            ...
                            <div class="flex items-center gap-0.5">
                                <span
                                    class="text-base text-darkBlue"
                                    :class="[report.statistics.avg_sales.progress < 0 ? 'icon-down-stat text-red-500 dark:!text-red-500' : 'icon-up-stat text-darkBlue dark:!text-darkBlue']"
                                ></span>

                                <p
                                    class="text-xs font-semibold"
                                    :class="[report.statistics.avg_sales.progress < 0 ?  'text-red-500' : 'text-darkBlue']"
                                >
