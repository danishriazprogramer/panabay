...
<header class="sticky top-0 z-10 hidden items-center justify-between border-b bg-navyBlue px-7 py-4 lg:flex">
    ...
    <div class="flex gap-7">
        ...
        >
            <span
                class="mp-home-icon text-white cursor-pointer rounded-md p-1 text-2xl transition-all hover:bg-gray-100"
        ...
        >
            <span
                class="mp-store-icon text-white cursor-pointer rounded-md p-1 text-2xl transition-all hover:bg-gray-100"
        ...
        >
            <span class="mp-notification-icon text-white cursor-pointer rounded-md p-1 text-2xl transition-all hover:bg-gray-100">
            </span>
        ...
        <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            <x-slot:toggle>
                <div class="flex items-baseline">
                    <span class="icon-users text-white cursor-pointer rounded-md p-1 text-2xl transition-all hover:bg-gray-100">
                    </span>
                </div>
            </x-slot>
