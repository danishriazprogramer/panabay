...
<x-shop::layouts
    ...
    <x-slot:title>
        ...
        <div class="container mt-5 max-1180:px-5">
            ...
            <!-- Form Container -->
            <div class="m-auto w-full max-w-[870px] rounded-xl  p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
                <h1 class="font-semibold text-2xl max-md:text-3xl max-sm:text-xl  text-center">
                    @lang('shop::app.customers.signup-form.page-title')
                </h1>

                <p class="mt-4 text-xl text-zinc-500 max-sm:mt-0 max-sm:text-sm  text-center">
                    Create your account and manage your orders, <br> billing and addresses.
                </p>
                ...
                <div class="mt-14 rounded max-sm:mt-8">
                    <x-shop::form :action="route('shop.customers.register.store')">
                        ...
                        <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:justify-center max-sm:gap-5">
                            <!-- Save Button -->
                            <label for="agreement" class="text-xs text-secondary">
                                By clicking Continue, you acknowledge you have read and agreed to our
                                <a class="text-primary hover:underline" href="/page/terms-of-use">Terms of Use</a> and
                                <a class="text-primary hover:underline" href="/page/privacy-policy">Privacy Policy</a>.
                            </label>
                            <button
                            ...
                            <div class="flex flex-wrap gap-4 text-center w-full" style="text-align: center;justify-content:center;">
                ...
                <p class="mt-5 font-medium text-zinc-500 text-center max-sm:text-sm">
